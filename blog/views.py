...
from .models import Category,Banner,Tag ,Link #从models里导入Category、Banner类
...
def list(request,lid):
    ...
    return render(request, 'list.html', locals()) #locals()代替了context，locals()的作用是返回一个包含当前作用域里面的所有变量和它们的值的字典。
